<template>
  <div>
      ...
      <el-card class="box-card">
        ...
        <div class="count-detail">
          <ul>
            ...
            <li>
              <span
                >成交订单金额（元）<i class="el-icon-question icolor"></i
              ></span>
            ...
            <li>
              <span
                >拍下订单金额（元）<i class="el-icon-question icolor"></i
              ></span>
              <span>{{ info.takeorderamount }}</span>
            </li>
            <li>
              <span
                >千次展现成本（元）<i class="el-icon-question icolor"></i
              ></span>
              <span>{{ info.ecpm }}</span>
            </li>
            <li>
    ...
    <div class="bottom-content">
      <el-card>
        <div class="tabs-css">
          ...
          <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
            ...
            <el-tab-pane label="计划" name="1"></el-tab-pane>
          </el-tabs>
        </div>
        <el-table
          :data="list"
          ...
          :default-sort="{ prop: 'plan_id', order: 'ascending' }"
        >
          <el-table-column
            prop="plan_id"
            label="PLANID"
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return (
                  specialNum(a.collectioncost) - specialNum(b.collectioncost)
                );
              }
            "
            width="150"
          >
            ...
            >
              <template #header>
                <el-input
                  v-Int
                  v-model.number.trim="query.collectioncost"
                  size="mini"
                  placeholder="请输入"
                  @change="inputChange"
                  @blur="searchReport(1)"
                  @keyup.enter.native="searchReport(1)"
                />
              </template>
            </el-table-column>
          </el-table-column>
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return specialNum(a.ecpm) - specialNum(b.ecpm);
              }
            "
            width="150"
          >
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return specialNum(a.adctr) - specialNum(b.adctr);
              }
            "
            :show-overflow-tooltip="true"
            width="100"
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return specialNum(a.ecpc) - specialNum(b.ecpc);
              }
            "
            width="120"
          >
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return specialNum(a.adpv) - specialNum(b.adpv);
              }
            "
            :show-overflow-tooltip="true"
            width="100"
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return specialNum(a.click) - specialNum(b.click);
              }
            "
            :show-overflow-tooltip="true"
            width="100"
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return (
                  specialNum(a.returnoninvestment) -
                  specialNum(b.returnoninvestment)
                );
              }
            "
            :show-overflow-tooltip="true"
          ...
          >
            ...
            >
              <template #header>
                <el-input
                  v-Int
                  v-model="query.returnoninvestment"
                  size="mini"
                  placeholder="请输入"
                  @change="inputChange"
                  @blur="searchReport(2)"
                  @keyup.enter.native="searchReport(2)"
                />
              </template>
            </el-table-column>
          </el-table-column>
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return (
                  specialNum(a.takeordervolume) - specialNum(b.takeordervolume)
                );
              }
            "
            :show-overflow-tooltip="true"
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return (
                  specialNum(a.transactionvolume) -
                  specialNum(b.transactionvolume)
                );
              }
            "
            :show-overflow-tooltip="true"
          ...
          >
            ...
            >
              <template #header>
                <el-input
                  v-Int
                  v-model="query.transactionvolume"
                  size="mini"
                  placeholder="请输入"
                  disabled
                  @change="inputChange"
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return (
                  specialNum(a.transactionamount) -
                  specialNum(b.transactionamount)
                );
              }
            "
            width="150"
          >
            ...
            >
              <template #header>
                <el-input
                  v-Int
                  v-model="query.transactionamount"
                  size="mini"
                  placeholder="请输入"
                  disabled
                  @change="inputChange"
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return specialNum(a.alipaycost) - specialNum(b.alipaycost);
              }
            "
            width="100"
          >
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return (
                  specialNum(a.takeorderamount) - specialNum(b.takeorderamount)
                );
              }
            "
            width="150"
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return specialNum(a.pagearrive) - specialNum(b.pagearrive);
              }
            "
            width="100"
          >
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return specialNum(a.convertcost) - specialNum(b.convertcost);
              }
            "
            width="100"
          >
          ...
          <el-table-column
            ...
            :sort-method="
              (a, b) => {
                return (
                  specialNum(a.addcartvolume) - specialNum(b.addcartvolume)
                );
              }
            "
            width="150"
      ...
      <el-button style="display: none" plain @click="open"
        >偏移的消息</el-button
      >
    </div>
  </div>
...
<script>
import { searchInput, accountList, planList, warningList, setWarningVal } from '@/api/bigdata/report'
...
export default {
  ...
  data(){
    return {
      ...
      lotStr: [], // 用于回显
      fetchFormat: ( list = [] ) => { //  下拉框数据格式
            return list.map(({lotName, lotId }) => ({ label: lotName, value:lotId }))
      },
      getAssetsList: searchInput,//请求下拉数据的接口
      fetchParams: { //  部分接口参数 其余参数在上面封装的组件内
          page: 1,
          search_value:[],
      },
    }
  ...
  methods:{
    ...
    async getPlanList(){
      ...
      planList(this.listQuery).then(res=>{
        if(res.status === 20000){
    ...
    handleDownload(){
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['PLANID', '账号名称','消耗','千万次展现成本','点击率','点击单价','展现量', '点击量', '投资回报率','拍下订单量','成交订单量','成交订单金额','订单成本','拍下订单金额', '转化数', '转化成本', '添加购物车量']
        const filterVal = ['plan_id', 'plan_name','collectioncost','ecpm','adctr','ecpc','adpv','click','returnoninvestment','takeordervolume','transactionvolume','transactionamount','alipaycost','takeorderamount','pagearrive','convertcost','addcartvolume']
